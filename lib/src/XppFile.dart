...
class XppFile {
  ...
  XmlDocument toXmlDocument() {
    return XmlDocument([
      XmlElement(
          XmlName('xournal'),
          [XmlAttribute(XmlName('version'), '1')],
          [
            XmlElement(XmlName('title'), const [], [
              XmlText(
                  'Xournal document - see http://math.mit.edu/~auroux/software/xournal/ - generated by Xournal++ Mobile - see https://gitlab.com/TheOneWithTheBraid/xournalpp_mobile/')
            ])
